...
public class UserLogin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//st.executeUpdate(" update tblvehicle set status='OUT' where  date(OutTime)>=(DATE(NOW()))");
			//st.executeUpdate(" update tblvehicle set status='out',outtime='"+outtime+"' where intime<outtime and outtime>=now()");
