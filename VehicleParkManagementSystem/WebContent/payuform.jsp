...
%>
<% 	
	String merchant_key="31gBP8JX";
	String salt="w1xUWReYIR";
	String action1 ="";
	...
	String txn="abcd";
	String hash="";
	String hashSequence = "key|txnid|amount|productinfo|firstname|email|udf1|txnid|udf3|udf4|udf5|udf6|udf7|udf8|udf9|udf10";
