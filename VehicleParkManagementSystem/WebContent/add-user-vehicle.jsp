				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							...
							<h6><center>Parking slot is full, Wait for sometime.</center></h6>
							<%
								}
							%>
							...
							<form action="AddOwnVehicle" method="post">
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="text-input" class=" form-control-label">In
											Time</label>
									</div>
									<div class="col-12 col-md-9">
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="text-input" class=" form-control-label">Out
											Time</label>
									</div>
									<div class="col-12 col-md-9">
								...
								<div class="row form-group">
									...
									<div class="col-12 col-md-9">
										<select name="loc" id="loc" class="form-control" required="true">
											<option value="0">Select Location</option>
											<%
												
													Statement statement1 = con.createStatement();
													ResultSet resultset1 = statement1.executeQuery("select * from location");
